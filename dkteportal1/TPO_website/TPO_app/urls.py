...
urlpatterns = [
    ...
    path('list_eligible_students/', views.list_eligible_students, name='list_eligible_students'),
    path('eligible_students_list/', views.list_eligible_students, name='list_eligible_students'),
]
